...
In this article, we provide a Python implementation for finding a conditional instrument in an ADMG based on the sound and complete criterion given by <Reference id="henckelIV" format="author(year)"/>. We rely on algorithmic ideas introduced in 
