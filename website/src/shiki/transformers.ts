  ...
  return {
    ...
    root(root: Root) {
      ...
      const headerDiv: Element = h(
        ...
        {
          class:
            "bg-gray-50 dark:bg-gray-600 font-mono border-b border-gray-200 dark:border-gray-800 px-2 py-2 flex items-center h-10.25",
        },
        h(
          "span",
          {
      ...
      const wrapper: Element = h(
        ...
        {
          class:
            "not-prose rounded-lg shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden",
        },
